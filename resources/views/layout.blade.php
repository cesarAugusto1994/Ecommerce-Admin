				...
				<div class="header-left">
					...
					<div class="ca-r">
						<div class="cart box_1">
							...
							<p><a href="javascript:;" data-token="{{ csrf_token() }}" class="simpleCart_empty">Empty Cart</a></p>
										...
										<div class="col1">
											<div class="h_nav">
												<ul>
													...
													<li><a class="btn btn-link btn-sm bottom-left" href="{{ route('logout') }}">Logout</a></li>
												</ul>
											</div>
										</div>
									</div>
